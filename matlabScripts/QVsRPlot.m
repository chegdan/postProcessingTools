...
title('Q vs. Radial Distance')
ylabel('Q [1/s^2]');
xlabel('r [m]');
print(h,'-dpdf','Qvsr.pdf');
...
title('Dimensionless Q vs. Dimensionless Radial Distance')
ylabel('Q [-]');
xlabel('r/d [-]');
print(h,'-dpdf','Qvsr_dim.pdf');
