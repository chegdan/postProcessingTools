...
%% import helicity
% helicity is a scalar, so we don't need as much information as before

Hfile = './pointData/helicity4500.dat';
...
title('Helicity vs. Radial Distance')
ylabel('H [m^2/s^2]');
xlabel('r [m]');
print(h,'-dpdf','helicityvsr.pdf');
...
title('Dimensionless Helicity vs. Dimensionless Radial Distance')
ylabel('H [-]');
xlabel('r/d [-]');
print(h,'-dpdf','helicityvsr_dim.pdf');
